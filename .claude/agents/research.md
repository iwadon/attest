...
5. Bash usage: `git log`, `git blame`, build commands (`cmake`, `ctest`)
...
✅ Find assertion macro implementations
✅ List test registration patterns
✅ Map assertion type dispatch via `_Generic`
✅ Identify CLI option handling
